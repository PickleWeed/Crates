          ...
          actions: <Widget>[
            Container(
              ...
              child: TextField(
                ...
                onChanged: (value) {
                  _search =
                      value.trim(); // store the password typed in the _password
                },
              ),
            ),
            IconButton(
  ...
  return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              ListingCard1("Old Town White Coffee", "leejunwei",
                  'assets/coffee.jpg', 'assets/icons/default.png', context),
              ListingCard1("Korean Spicy Noodles Samyang", "Eggxactly",
                  'assets/noodles.jpg', 'assets/icons/default.png', context),
            ],
          ),
          Row(
            children: [
